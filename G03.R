...
# 4. 'train' function: Trains the neural network using forward and
...
# Output: An initialised network list containing  a list for each h (empty
# nodes for each layer), w (weight matrices), b (offset vectors)
